...
---
- _**Nota:** La respuesta es IP porque, en el proceso de recibir datos y "desempaquetarlos" capa por capa, la Capa de Internet (con el protocolo IP) es la que sigue inmediatamente después de la Capa de Acceso a la Red (donde opera Ethernet)._
---
