...
![Animación del proceso de encapsulamiento TCP/IP](images/image5.gif)
...
* [ ] EIGRP
* [X] Envenenamiento _**(A veces, en seguridad de red, se habla de "Envenenamiento de caché DNS" o "Envenenamiento ARP", que son ataques o vulnerabilidades que explotan debilidades en ciertos protocolos, pero "Envenenamiento" por sí solo no es el nombre de un protocolo)**_
* [ ] Funciones
* [ ] ICMP
* [x] DHCP
